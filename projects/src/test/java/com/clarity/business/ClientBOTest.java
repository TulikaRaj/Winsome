...
public class ClientBOTest {
	...
	@Test
	public void testClientProductSum0() throws DifferentCurrenciesException {

		List<Product> products = new ArrayList<Product>();
		System.out.println(products.size());
		if (products.size() == 0) {
			Amount temp1 = clientBO.getClientProductsSum(products);
		assertEquals(new AmountImpl(new BigDecimal("0"),Currency.EURO),temp1.equals(0));
